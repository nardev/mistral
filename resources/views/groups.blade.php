...
<div class="row" style="min-height: 700px; padding: 10px 0 50px 0;">
        <div class="col-sm-6 col-md-6" id="groups">
...
<script type="text/javascript">
	...
	$('.archiveGroup').click(function(event){
	    ...
	    $.ajax({
            ...
            data        : "",
	        encode      : true,
	        success: function(result){$("#groups").prepend(result); }
	    })
	    .done(function(data) {
	...
	$('#createGroup').click(function(event){
	    ...
	    $.ajax({
	        ...
	        error: function(result){
	        	$("#groups").prepend('<div class="alert alert-danger error" role="alert">ERROR</div>');
